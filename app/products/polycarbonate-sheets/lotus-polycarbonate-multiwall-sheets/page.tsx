...
export default function SPolytechMultiwallPage() {
  ...
  const images = [
    "/new-images/lotus-polycarbonate-multiwall-sheets/1.jpg",
    "/new-images/lotus-polycarbonate-multiwall-sheets/2.jpg",
    "/new-images/lotus-polycarbonate-multiwall-sheets/3.jpg",
  ];
